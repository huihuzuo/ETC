...
<script>
  ...
  const _layerName = 'identificPoint' // 标识点
    ...
    methods: {
      ...
      queryResultList () {
        ...
        let _params = {
          ...
          name: this.queryParams && this.queryParams._params && this.queryParams._params.id ? this.queryParams._params.id : null, // 标识点名称
          type: this.queryParams && this.queryParams._params && this.queryParams._params.type ? this.queryParams._params.type : null, // 标识点类型
          id: this.queryParams && this.queryParams._params && this.queryParams._params.division ? this.queryParams._params.division : null, // 标识点编码
        ...
        this.$api.loadIdentificPointList(_params).then(res => {
