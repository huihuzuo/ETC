    ...
    methods: {
      ...
      queryResultList () {
        ...
        let _params = {
          ...
          name: this.queryParams && this.queryParams._params && this.queryParams._params.name ? this.queryParams._params.name : null, // 加油站名称
          companyNum: this.queryParams && this.queryParams._params && this.queryParams._params.companyNum ? this.queryParams._params.companyNum : null, // 石化企业
          ...
          id: this.queryParams && this.queryParams._params && this.queryParams._params.id ? this.queryParams._params.id : null, // 加油站编码
          operations: operations
        }
        this._params = _params
        this.$api.loadGasStationList(_params).then(res => {
